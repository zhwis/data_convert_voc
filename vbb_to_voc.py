...
def seq2img(annos, seq_file, outdir, cam_id):
    ...
    #print("frame cap video:",cap_frames_index)
    ...
    while True:
        ...
        if ret:
            ...
            break
	test_seq = ['set06','set07','set08','set09','set10']
	if str(cam_id) in test_seq: 
            index += 30
	else:
	    index += 5
...
def parse_anno_file(seq_inputdir, vbb_inputdir, vbb_outputdir, seq_outputdir, person_types=None):
    """
    ...
    for sub_dir in sub_dirs:
		...
		vbb_outdir = os.path.join(vbb_outputdir)
		...
		seq_outdir = os.path.join(seq_outputdir)
...
def main():
    ...
    parser.add_argument("--seq_dir", default="/zhihui/CaltechDataset/seq", help="Caltech dataset seq data root directory")
    parser.add_argument("--vbb_dir", default="/zhihui/CaltechDataset/vbb/annotations", help="Caltech dataset vbb data root directory")
    parser.add_argument("--output_dir", default="/zhihui/CaltechDataset/output", help="Root saving path for frame and annotation files")
    ...
    parse_anno_file(args.seq_dir, args.vbb_dir, anno_out, frame_out, person_type)
...
def test():
    ...
    person_types = ["person"]
    #parse_anno_file(seq_inputdir, vbb_inputdir, vbb_outputdir, seq_outputdir, person_types=person_types)
    xml_file = "/zhihui/CaltechDataset/output_pull_path/annotation/annotations/set02/bbox/set02_V001_1559.xml"
    img_file = "/zhihui/CaltechDataset/output_pull_path/frame/set02/frame/set02_V001_1559.jpg"
